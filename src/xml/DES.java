...
public class DES {
	...
	protected static String rezultat;
	
    public String getRezultat() {
		return rezultat;
	}
	// tabelul pentru permutarea initiala IP
	...
	public static void permutte(String txt,String key)
	{
		...
		for(int i=0 ; i < 16 ; i++) {
			...
			// string
			String s = Integer.toBinaryString(Integer.parseInt(txt.charAt(i) + "", 16));
		...
		//rezultat = String.valueOf(outputBits);
